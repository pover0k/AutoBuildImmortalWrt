...
uci set "dhcp.@domain[-1].ip=108.156.144.63"
uci add dhcp domain
uci set "dhcp.@domain[-1].name=edge.forgecdn.net"
uci set "dhcp.@domain[-1].ip=108.156.144.77"
uci add dhcp domain
uci set "dhcp.@domain[-1].name=media.forgecdn.net"
uci set "dhcp.@domain[-1].ip=3.171.198.127"
uci add dhcp domain
uci set "dhcp.@domain[-1].name=mediafilez.forgecdn.net"
uci set "dhcp.@domain[-1].ip=3.170.229.99"
uci add dhcp domain
uci set "dhcp.@domain[-1].name=sessionserver.mojang.com"
uci set "dhcp.@domain[-1].ip=13.107.246.50"
